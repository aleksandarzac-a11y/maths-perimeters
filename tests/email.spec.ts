...
test("sends report email via /api/send-report", async ({ request }) => {
  ...
  const response = await request.post(`${BASE_URL}/api/send-report`, {
    data: {
      ...
      totalQuestions: 3,
      accuracy: 100,
      gameName: "Perimeter Explorer",
      senderName: "SeeMaths Perimeter Explorer",
      siteUrl: "https://www.seemaths.com",
      sessionTime: "10:00 am",
      sessionDate: "6th Apr",
      durationText: "2 minutes",
      stageLabel: "Stage 3 NSW Curriculum",
      curriculumCode: "MA3-GM-02",
      curriculumDescription: "Measures lengths and distances including perimeters",
      reportFileName: "perimeter-report-test-explorer.pdf",
    },
  });
  ...
  console.log("Check your inbox for the Perimeter Explorer report.");
});
