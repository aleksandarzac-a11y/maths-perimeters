...
export default async function handler(req: any, res: any) {
  ...
  const reportFileName = payload?.reportFileName || "perimeter-report.pdf";
  const senderName = payload?.senderName || "Perimeter Explorer";
  const gameName = payload?.gameName || "Perimeter Explorer";
