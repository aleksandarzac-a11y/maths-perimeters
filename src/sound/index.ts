...
const MUSIC_PATTERNS: MusicPattern[] = [
  {
    melody: [659.25, 783.99, 987.77, 0, 783.99, 659.25, 587.33, 0, 659.25, 783.99, 987.77, 1046.5, 987.77, 783.99, 659.25, 0],
    bass: [130.81, 0, 164.81, 0, 146.83, 0, 130.81, 0, 110.0, 0, 130.81, 0, 146.83, 0, 164.81, 0],
    bpm: 148,
    melodyType: "square",
    bassType: "triangle",
  },
