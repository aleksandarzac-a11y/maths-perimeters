...
const GAME_NAME = "Perimeter Explorer";
const SENDER_NAME = "Perimeter Explorer";
...
const CURRICULUM_BY_LEVEL = {
  1: {
    code: "MA3-GM-02",
    syllabusUrl: "https://curriculum.nsw.edu.au/learning-areas/mathematics/mathematics-k-10-2022/content/stage-3/ma3-gm-02",
  },
  2: {
    code: "MA3-GM-02",
    syllabusUrl: "https://curriculum.nsw.edu.au/learning-areas/mathematics/mathematics-k-10-2022/content/stage-3/ma3-gm-02",
...
function getReportFileName(summary: SessionSummary): string {
  ...
  return `perimeter-report-${name}-${stamp}.pdf`;
}
