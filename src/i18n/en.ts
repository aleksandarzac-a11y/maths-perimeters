...
const en: Translations = {
  ...
  "toolbar.showSquareSnip": "Show square snip tool",
  "toolbar.hideSquareSnip": "Hide square snip tool",
  "toolbar.recordDemo": "Record demo video",
  "toolbar.watchHowToPlay": "Watch how to play",
  ...
  // Game / RippleScreen
  "game.tapScreen": "Trace the lap! ({count}/{total})",
  "game.correct": "Correct!",
  "game.wrongAnswer": "Wrong! It was {answer}",
  "game.levelComplete": "Level Complete!",
  "game.entryPrompt": "What is the answer?",
  "game.tryOnYourOwn": "Try on your own",
  "game.tapAnywhere": "Tap the next checkpoint!",
  ...
  "pdf.gameDescription": "Perimeter and Metric Measurement",
  "pdf.objectiveLabel": "Objective:",
  "pdf.objectiveText": "Trace outside boundaries, add side lengths, and solve perimeter or missing-side questions.",
  ...
  "pdf.rippleCount": "{count} checkpoint(s)",
  ...
  "pdf.footer": "Generated by SeeMaths - Perimeter Explorer",
  ...
  // Curriculum
  "curriculum.stageEarlyStage1": "Stage 3 NSW Curriculum",
  "curriculum.outcomeMae1wm": "MA3-GM-02 - measures lengths and distances including perimeters",
