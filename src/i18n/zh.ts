...
const zh: Translations = {
  ...
  "toolbar.showSquareSnip": "显示方形截取工具",
  "toolbar.hideSquareSnip": "隐藏方形截取工具",
  "toolbar.recordDemo": "录制演示视频",
  "toolbar.watchHowToPlay": "观看玩法说明",
  ...
  // Game
  "game.tapScreen": "描出一圈！({count}/{total})",
  "game.correct": "正确！",
  "game.wrongAnswer": "错误！正确答案是 {answer}",
  "game.levelComplete": "关卡完成！",
  "game.entryPrompt": "答案是多少？",
  "game.tryOnYourOwn": "自己试一试",
  "game.tapAnywhere": "点击下一个检查点！",
  ...
  "pdf.gameDescription": "周长与公制度量",
  "pdf.objectiveLabel": "目标：",
  "pdf.objectiveText": "描出外边界，累加边长，并解决周长或缺失边问题。",
  "pdf.scoreLabel": "得分",
  ...
  "pdf.footer": "由 SeeMaths - Perimeter Explorer 生成",
  ...
  // Curriculum
  "curriculum.stageEarlyStage1": "新南威尔士州课程第 3 阶段",
  "curriculum.outcomeMae1wm": "MA3-GM-02 - 测量长度和距离，包括周长",
